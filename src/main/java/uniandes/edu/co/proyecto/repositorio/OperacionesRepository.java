...
public interface OperacionesRepository extends JpaRepository<Operaciones, String>{
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO OPERACIONES ( fecha, tipo, valor, cuenta) VALUES (:fecha, :tipo, :valor, :cuenta)", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE OPERACIONES SET tipo = :tipo, estado = :estado, operacion_a_hacer = :operacion_a_hacer, monto = :monto, interes = :interes, cuotas = :cuotas, dia_pago = :dia_pago, valor_cuota = :valor_cuota WHERE id = :id", nativeQuery = true)
